...
if n != 3:
    ...
    #os.rename(cwd+"/figures/umap.png",result_file+"umap.png")   # the plots are saved in a directory by default and hence move it for it to be recognised as output
    #os.rename(cwd+"/figures/rank_genes_groups_leiden.png",result_file+"rank_genes_groups_leiden.png")
